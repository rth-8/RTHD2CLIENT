...
class ItemState(Enum):
    ...
    Locked=1
    # If this bit is set, the item is a quest that's being tracked by the user. 
    # You may want a visual indicator to show that this is a tracked quest.
    Tracked=2
    # If this bit is set, the item has a Masterwork plug inserted. 
    # This usually coincides with having a special "glowing" effect applied to the item's icon.
    Masterwork=4
